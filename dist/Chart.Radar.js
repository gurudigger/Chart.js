	...
	Chart.Type.extend({
		...
		initialize: function(data){
			...
			helpers.each(data.datasets,function(dataset){
				...
				var datasetObject = {
					...
					strokeColor : (this.options.needstrokeLine) ?  dataset.strokeColor : dataset.fillColor,
		...
		buildScale : function(data){
			this.scale = new Chart.RadialScale({
				...
				angleLineColor : this.options.angleLineColor || "rgba(182, 182, 182, 1)",
